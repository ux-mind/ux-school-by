...
<div id="order-modal" class="modal order-modal">
	<p class="modal__title order-modal__title">Записаться</p>
	<?php echo do_shortcode('[contact-form-7 id="859" crm-tag-date="'. $tag_date_string .'" crm-status-id="32222008" crm-course-full-title="' . esc_html( get_the_title( $course_post_object ) ) . ' ' . str_replace( '/', '.', $course_post_day ) . '" crm-course-lecturer="' . $crm_course_lecturer . '" crm-course-address="Онлайн" crm-course-date="' . $crm_course_date . '" crm-course-time="' . $crm_course_time . '" crm-course-price="' . 0 . '" crm-course-type="Онлайн" ums-course-date="' . $course_start_date_string . '" ums-course-name="' . esc_html( get_the_title( $course_post_object ) ) . '" ums-course-timetable="' . $course_posts_timetable . '" html_class="form modal__form order-modal__form" autocomplete="off"]'); ?>
