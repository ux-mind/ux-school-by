...
<section class="section about">
    ...
    <div class="about__wrapper">
        ...
        <?php elseif ($is_course_free): ?>
            <button <?php if ($is_course_full): ?>disabled<?php endif; ?> type="button" data-modal="#order-modal" class="btn about__btn"><?php if ($is_course_full): ?>Группа набрана<?php else: ?>Хочу участвовать<?php endif; ?></button>
        <?php else: ?>
